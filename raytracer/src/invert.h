...
static void invert_matrix (double A[4][4], double Ainv[4][4]) {
  int i, j;
  double det ;
...
static void adjoint( double in[4][4], double out[4][4] ) {
...
static double det3x3( double a1, double a2, double a3, double b1, double b2, double b3, double c1, 
			  double c2, double c3 )
{
  double ans;
